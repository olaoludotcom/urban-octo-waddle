        ...
        <td width="584" valign="top"><table width="581" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="581" height="57"><br>
                <img src="images/contactus.jpg" width="250" height="23"></td>
          </tr>
          <tr>
            <td height="289"><table width="560" height="387" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="68" colspan="2"><p align="justify">We are able to deliver world-class services by identifying the exact needs of our clients and finding that person with the right mix of skills to provide it. We therefore leverage not only on the collective skills of our staff but also our associates to solve client's complex problems. </p></td>
                </tr>
                <tr>
                  <td width="241" height="252"><div align="center"><img src="images/contact.jpg" width="200" height="250"></div></td>
                  <td width="319"><p align="justify"><strong>Our Address </strong> ::: </p>
                      <p align="justify">Norwood Business Haus Limited <br>
                        4, Obanikoro Street<br>
                        Obanikoro Estate<br>
                        Lagos
                        Nigeria.</p>
                    <p align="justify"><strong>Telephone</strong> :::</p>
                    <p align="left">+234 8022241473, +234-1-7917453, +234-1-2903468</p>
                    <p align="justify"><strong>Email</strong> :::</p>
                    <p align="justify"><a href="mailto:info@norwoodbusinesshaus.com" target="_blank">info@norwoodbusinesshaus.com</a> </p></td>
                </tr>
            </table></td>
          </tr>
        </table></td>
