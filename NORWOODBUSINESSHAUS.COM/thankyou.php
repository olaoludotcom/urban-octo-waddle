    ...
    <td height="542" bgcolor="#FFFFFF"><table width="778" border="0" cellpadding="0" cellspacing="0">
      <tr>
		...
		<blockquote>Thank you
          <p>You can now login with you username and password 
		  </blockquote><form method="POST" action="<?php echo $loginFormAction; ?>" name="forum">
		  <table width="417" border="0" cellpadding="2" cellspacing="0">
            ...
            <p>&nbsp;</p></td>
        <td width="194"><iframe marginwidth="0" 
            marginheight="0" src="right.php" 
            frameborder="0" width="194" height="1" target="contents"></iframe></td>
      </tr>
      <tr>
