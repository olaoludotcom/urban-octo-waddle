...
$news = mysql_query($query_news, $admin) or die(mysql_error());
...
$query_DetailRS1 = "SELECT * FROM news WHERE id = $recordID";
$query_limit_DetailRS1 = sprintf("%s LIMIT %d, %d", $query_DetailRS1, $startRow_DetailRS1, $maxRows_DetailRS1);
$DetailRS1 = mysql_query($query_limit_DetailRS1, $admin) or die(mysql_error());
    ...
    <td height="542" bgcolor="#FFFFFF"><table width="778" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="584" valign="top"><table width="581" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="289"><table width="578" height="366" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="313" valign="top"><table border="1" align="center">
                    <tr>
                      <td>id</td>
                    ...
                    <tr>
                      <td>topic</td>
                      <td><?php echo $row_DetailRS1['topic']; ?> </td>
                    </tr>
                    <tr>
                      <td>news</td>
                      <td><?php echo $row_DetailRS1['news']; ?> </td>
                    </tr>
                    <tr>
                      <td>date</td>
                    ...
                    <p>&nbsp;</p>
                    <p align="justify"><a href="news.html" target="_parent"><span class="style22"><br>
                      </span></a></p></td>
                  </tr>
            </table></td>
          </tr>
