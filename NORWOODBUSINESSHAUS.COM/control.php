    ...
    <td height="542" bgcolor="#FFFFFF"><table width="778" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="584" valign="top">
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <table width="564" border="1" cellpadding="4" cellspacing="5" bordercolor="#CCCCCC">
            <tr>
              <td width="259"><div align="center"><a href="forummembers.php">Registered users on forum </a></div></td>
              <td width="268"><div align="center"><a href="newsupdate.php">Update news / Event</a> </div></td>
            </tr>
          </table>
