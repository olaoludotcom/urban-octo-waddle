        ...
        <td height="299" valign="top"><table width="779" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="271" background="images/ban.jpg"><table width="779" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="58" height="260">&nbsp;</td>
                <td width="299" valign="bottom"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
  codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,42,0"
  id="can" width="299" height="132">
                    <param name="movie" value="can.swf">
                    <param name="quality" value="high">
                    <param name="wmode" value="transparent">
                    <param name="bgcolor" value="#F6F6F6">
                    <embed name="can" src="can.swf"
     quality="high" wmode="transparent" bgcolor="#F6F6F6" swLiveConnect="true"
     width="299" height="132"
     type="application/x-shockwave-flash"
     pluginspage="http://www.macromedia.com/go/getflashplayer"></embed>
                  </object>
                    <br></td>
                <td width="422" valign="bottom">&nbsp;</td>
              </tr>
            </table></td>
          </tr>
          <tr>
        ...
        <td width="584" valign="top"><table width="581" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="581" height="57"><br>
                <img src="images/e-training.jpg" width="238" height="23"></td>
          </tr>
          <tr>
            <td height="289"><table width="560" height="258" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="236" height="258"><div align="center"><img src="images/etraining.jpg" width="200" height="250"></div></td>
                  <td width="324"><p align="justify">&nbsp;</p>
                      <p align="justify">The quality of the workforce determines the sucess of any organisation. Norwood's robust training programmes are designed to enchance the skills and requisite knowlegde of your staff for optimal performance. </p>
                    <p align="justify">Our training programmes are tailored towards surmounting human capital developement challenges. </p>
                    <p align="justify">The thrust of our training programmes, therefore, revolves around strategy development and business performance management aimed at helping organisations acheive their main objectives.</p>
                    <p align="justify">We achieve these through the following methods:<br>
                          <br>
                          <strong>o</strong> <a href="etraining.php">Open Training </a> <br>
                          <strong>o</strong> <a href="etraining.php">In-house Training</a> <br>
                          <strong>o</strong> <a href="etraining.php">Specialised Training</a></p></td>
                </tr>
            </table></td>
          </tr>
        </table></td>
