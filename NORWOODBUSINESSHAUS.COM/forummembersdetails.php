...
$forumuser = mysql_query($query_forumuser, $admin) or die(mysql_error());
$row_forumuser = mysql_fetch_assoc($forumuser);
$totalRows_forumuser = mysql_num_rows($forumuser);
    ...
    <td height="542" bgcolor="#FFFFFF"><table width="778" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="584" valign="top"><p><br>
          ...
          <table width="376" border="1" align="center" cellpadding="2" cellspacing="1" bordercolor="#CCCCCC">
            <tr>
              <td>Id</td>
