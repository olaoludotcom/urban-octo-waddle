...
<BODY>
<?php
$msg = "Feedback from Norwood's website. \n\n";
$msg .= "Name: $_POST[name]\n";
...
$email =  $_POST[email];
//set up the mail
$subject = "Feedback sent from Norwood's website";//$_POST[subject];
$recipient = "info@norwoodbusinesshaus.com"; //$_POST[recipient];
$mailheaders = "From: Norwood website $email";
        ...
        <td width="584" valign="top"><table width="581" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="289"><table width="546" height="339" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="262" height="286" valign="top"><div align="center"><img src="images/feedback.jpg" width="200" height="250"></div></td>
                  <td width="290" valign="top"><p><strong>Thank you <?php echo $name?>!
                    </strong></p>
                    <p>We have recieved your information, we will get back to you soon.  </p>
                    <p>&nbsp;</p>
                    <p><a href="http://norwoodbusinesshaus.com">Norwood Business Haus</a>. </p>
